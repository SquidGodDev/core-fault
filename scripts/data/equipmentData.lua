...
equipment = {
    shockProd = {
        ...
        levelStats = {
            {damage = 6, hitStun = 2},
            {damage = 3, cooldown = -200, hitStun = 5},
            {damage = 6, hitStun = 4},
            {damage = 3, cooldown = -200, hitStun = 5},
            {damage = 6, cooldown = -100, hitStun = 10},
        },
    ...
    beam = {
        ...
        levelStats = {
            {length = 24, hitStun = 5},
            {cooldown = -200, damage = 6, length = 12},
            {damage = 10, cooldown = -200, hitStun = 5},
            {damage = 6, cooldown = -300, length = 16, hitStun = 5},
            {damage = 10, cooldown = -200, length = 24, hitStun = 5},
        },
    ...
    subterraneanRocket = {
        ...
        hitStun = 20,
        levelStats = {
            {damage = 6, radius = 8, distance = 12},
            {damage = 6, cooldown = -100, hitStun = 4, distance = 14, radius = 8},
            {radius = 12, cooldown = -200, hitStun = 4, distance = 10},
            {damage = 6, hitStun = 4, distance = 12},
            {damage = 6, cooldown = -200, radius = 16, hitStun = 10, distance = 10},
        },
    ...
    plasmaCannon = {
        ...
        levelStats = {
            ...
            {damage = 12, hitStun = 5},
            {velocity = 1, cooldown = -200, hitStun = 10},
            {damage = 6, velocity = 1, cooldown = -200, hitStun = 10},
        },
