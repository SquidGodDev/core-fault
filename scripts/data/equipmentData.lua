...
equipment = {
    ...
    beam = {
        ...
        levelStats = {
            ...
            {damage = 6, cooldown = -300, length = 16},
            {damage = 10, cooldown = -200, length = 24},
        },
    ...
    subterraneanRocket = {
        ...
        levelStats = {
            {damage = 6, radius = 8},
            {damage = 6, cooldown = -100},
            {radius = 12, cooldown = -200},
            {damage = 6},
            {damage = 6, cooldown = -200, radius = 16},
        },
    ...
    plasmaCannon = {
        ...
        levelStats = {
            ...
            {damage = 12},
            {velocity = 1, cooldown = -200},
            {damage = 6, velocity = 1, cooldown = -200},
        },
